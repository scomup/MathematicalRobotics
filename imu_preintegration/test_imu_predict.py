...
if __name__ == '__main__':
    ...
    imuIntegratorGT = gtsam.PreintegratedImuMeasurements(imu_params, gtsam.imuBias.ConstantBias(np.array([0.0,-0.0,-0.0]),np.array([0.,0.,0.])))
    ...
    for i in imu:
        ...
        currStateGT = imuIntegratorGT.predict(stateGT, gtsam.imuBias.ConstantBias(np.array([0.01,0.01,0.02]),np.array([0.0,0.0,0.0])))
        ...
        trj2.append([currStateGT.pose().translation()[0],currStateGT.pose().translation()[1],currStateGT.pose().translation()[2]])
